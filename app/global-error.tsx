...
// Désactiver complètement le prerender pour global-error
// Cette page est rendue en dehors du layout normal
...
export default function GlobalError({
  ...
  // Toujours appeler useEffect (règle des hooks React)
  // Mais vérifier si on est côté client avant de logger
  useEffect(() => {
    // Log l'erreur pour le débogage seulement côté client
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#4B4F58]">
                    Une erreur critique s'est produite. Vous pouvez retourner à la page d'accueil ou réessayer.
                  </p>
                </div>
              </div>
